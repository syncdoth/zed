...
impl Settings for GitPanelSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        Self {
            ...
            git_graph: {
                let git_graph = git_panel.git_graph.unwrap();
                GitGraphSettings {
                    show_local_branches: git_graph.show_local_branches.unwrap(),
                    show_remote_branches: git_graph.show_remote_branches.unwrap(),
                    show_tags: git_graph.show_tags.unwrap(),
                }
            },
        }
    }
